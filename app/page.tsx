...
export default function Portfolio() {
  const projects = [
    {
      title: "Weather App",
      description: "A comprehensive weather application with user authentication and real-time data",
      technologies: ["React", "React Query", "React Hook Form", "Zod", "Firebase", "React Router", "Vercel"],
      demoUrl: "#",
      githubUrl: "#",
      features: [
    ...
    },
    {
      ...
      description: "Interactive dashboard for visualizing customer transaction data",
      technologies: ["React", "Recharts", "Tailwind CSS", "JSON Server", "Vite", "Vercel"],
      demoUrl: "#",
      githubUrl: "#",
      features: [
    ...
    {
      title: "To-Do List",
      description: "Feature-rich task management application with local storage persistence",
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between px-4">
          <div className="font-semibold text-lg text-primary">Youssef Bassiem</div>
      ...
      <main className="container mx-auto px-4 py-8 space-y-16">
        ...
        <ScrollAnimation>
          <section className="text-center space-y-6 py-12">
            <div className="space-y-4">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground text-balance">Junior Front-End Developer</p>
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="text-muted-foreground leading-relaxed text-center max-w-3xl mx-auto">
                  I'm a passionate Junior Front-End Developer with a Bachelor's degree in Computer Science from Ain
                  Shams University. I specialize in building modern, responsive web applications using React,
                  TypeScript, and cutting-edge technologies. With experience in both frontend development and mentoring,
                  I'm dedicated to creating exceptional user experiences and contributing to innovative projects.
                </p>
              </CardContent>
            </Card>
          </section>
              ...
              <CardHeader>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription>Faculty of Computer and Information Science, Ain Shams University</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="font-medium">Duration:</span> Sep 2020 – Jul 2024
                  </div>
                  <div>
                    <span className="font-medium">Grade:</span> Very Good (GPA 3.1)
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <CardContent className="flex-1">
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-start gap-2">
                      ...
                      Contributed to a large-scale educational platform built with Angular 12 and ASP.NET Core
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      Identified and addressed major issues in legacy codebase lacking clean coding practices
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      Investigated and resolved performance bottlenecks in form handling and API integration
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="h-full flex flex-col">
                <CardHeader>
                  <div className="flex items-start gap-3">
                    <Briefcase className="h-6 w-6 text-primary mt-1" />
                    <div>
                      <CardTitle>Open Source Community (OSC)</CardTitle>
                      <CardDescription>Web Instructor & HR Member • Mar 2020 – Jul 2024</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="flex-1">
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      Mentored a front-end team of 8 students in React.js development
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      Created React.js curriculum from scratch for teaching students React basics
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      Helped 2 teams of 5 students each create a website for OSC community
                    </li>
                  </ul>
                </CardContent>
              </Card>
          ...
          <section id="skills" className="space-y-8">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              {Object.entries(skills).map(([category, skillList], categoryIndex) => (
                <ScrollAnimation key={category} delay={700 + categoryIndex * 100}>
                  <Card className="h-full">
                    <CardHeader>
                    ...
                    <CardContent>
                      <div className="grid grid-cols-2 gap-3">
                        {skillList.map((skill, index) => (
                          <ScrollAnimation key={skill.name} delay={800 + categoryIndex * 100 + index * 50}>
                            <SkillIcon {...skill} />
                          </ScrollAnimation>
                        ))}
                      </div>
        ...
        <ScrollAnimation delay={900}>
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-center">Achievements & Awards</h2>
              ...
              <Card className="h-full flex flex-col">
                <CardHeader>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <CardTitle className="text-lg">Contest Achievements</CardTitle>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="space-y-3 flex-1">
                  <div className="text-sm">
                    <div className="font-medium">Top 3 - Data Structure Contest</div>
                    <div className="text-muted-foreground">University competition (2022) - Out of 100+ teams</div>
                  </div>
                  <div className="text-sm">
                    <div className="font-medium">5th Place - UI/UX Workshop Contest</div>
                    <div className="text-muted-foreground">University workshop (2022) - Out of 25+ teams</div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <div className="flex gap-2 justify-center">
                      <Button size="icon" variant="outline" asChild>
                        <a href="https://linkedin.com/in/Youssef-Bassiem" target="_blank" rel="noopener noreferrer">
                          <Linkedin className="h-4 w-4" />
                        </a>
                      </Button>
                      <Button size="icon" variant="outline" asChild>
                        <a href="https://github.com/Youssef-Bassiem" target="_blank" rel="noopener noreferrer">
